  ...
  return (
    <>
          ...
          <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
            ...
            <div>
              <div className='lg:w-[570px]'>
                ...
                <p className='text__para'>Lorem Ipsum is simply dummy text of the printing and typesetting
                  industry. Has been the industry standard dummy text. It was popularised in the 1960s with
      ...
      <section>
       ...
       <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px'></div>    
      
      <div className='py-[39px] px-5'>
